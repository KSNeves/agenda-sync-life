            ...
            {todayRevisions.length === 0 ? (
              ...
              <div className="space-y-3">
                {todayRevisions.map(revision => (
                  <div key={revision.id} className="bg-secondary/60 backdrop-blur-sm p-5 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all duration-300 hover:bg-secondary/80 hover:shadow-lg border border-border/30">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                      <button
                        ...
                        className="flex items-center justify-center gap-1 px-2 sm:px-3 py-1 bg-blue-500 text-white rounded text-xs sm:text-sm hover:bg-blue-600 transition-colors min-h-[32px]"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 px-2 sm:px-3 py-1 bg-green-500 text-white rounded text-xs sm:text-sm hover:bg-green-600 transition-colors min-h-[32px]"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 px-2 sm:px-3 py-1 bg-yellow-100 hover:bg-yellow-200 text-yellow-800 rounded text-xs sm:text-sm font-medium transition-colors min-h-[32px]"
                      >
