...
const translations = {
  pt: {
    ...
    'schedule.eventDeleted': 'Evento excluído com sucesso',
    ...
    'revision.revisionsFor': 'Revisões para',
    'revision.noRevisionsToday': 'Nenhuma revisão para hoje! 🎉',
    'revision.noUpcomingRevisions': 'Nenhuma revisão próxima',
    'revision.noCompletedRevisions': 'Nenhuma revisão concluída',
    'revision.viewContent': 'Ver Conteúdo',
    'revision.complete': 'Concluir',
    'revision.postpone': 'Adiar',
    'revision.delete': 'Excluir',
    'revision.title.placeholder': 'Título da revisão',
    'revision.content.placeholder': 'Conteúdo da revisão',
    'revision.tags.placeholder': 'Tags (separadas por vírgula)',
    'revision.difficulty': 'Dificuldade',
    'revision.easy': 'Fácil',
    'revision.medium': 'Médio',
    'revision.hard': 'Difícil',
    'revision.created': 'Revisão criada com sucesso',
    'revision.updated': 'Revisão atualizada com sucesso',
    'revision.deleted': 'Revisão excluída com sucesso',
    'revision.confirmDelete': 'Tem certeza que deseja excluir esta revisão?',
    'revision.editRevision': 'Editar Revisão',
    'revision.saveRevision': 'Salvar Revisão',
    'revision.cancelRevision': 'Cancelar',
    'revision.titleLabel': 'Título da Revisão:',
    'revision.titlePlaceholder': 'Ex: Conceitos de Cálculo I',
    'revision.contentLabel': 'Conteúdo para Revisar:',
    'revision.contentPlaceholder': 'Descreva o que precisa ser revisado em detalhes...',
    'revision.subjectLabel': 'Assunto/Disciplina (Opcional):',
    'revision.subjectPlaceholder': 'Ex: Matemática, Biologia, História',
    'revision.timeLabel': 'Tempo Estimado (minutos):',
    'revision.timePlaceholder': '30',
    'revision.nonStudyDaysLabel': 'Dias que não estuda (opcional):',
    'revision.nonStudyDaysDescription': 'As revisões programadas para estes dias serão automaticamente adiadas para o próximo dia útil.',
    'revision.createTitle': 'Criar Nova Revisão',
    'revision.createDescription': 'Configure uma nova revisão com sistema de repetição espaçada',
    'revision.create': 'Criar Revisão',
    'revision.cancel': 'Cancelar',
    ...
    'flashcards.deckDescription': 'Descrição do Deck',
    ...
    'flashcards.deckDeleted': 'Deck excluído com sucesso',
    'flashcards.cardCreated': 'Card criado com sucesso',
    'flashcards.cardUpdated': 'Card atualizado com sucesso',
    'flashcards.cardDeleted': 'Card excluído com sucesso',
    'flashcards.deckNamePlaceholder': 'Digite o nome do deck',
    'flashcards.deckDescriptionPlaceholder': 'Digite uma descrição opcional',
    'flashcards.createNewDeck': 'Criar Novo Deck',
    'flashcards.deckDetailsDescription': 'Configure os detalhes do seu novo deck de flashcards',
    ...
    'settings.notifications.desc': 'Configure suas preferências de notificação',
    'settings.emailNotifications': 'Notificações por email',
    'settings.pushNotifications': 'Notificações push',
    'settings.pushNotifications.desc': 'Receba notificações no seu dispositivo',
    'settings.saveChanges': 'Salvar alterações',
    'settings.changesSaved': 'Alterações salvas com sucesso!',
    'settings.changesSaved.desc': 'Suas configurações foram atualizadas',
    ...
    'settings.pomodoro.desc': 'Configure suas sessões de foco',
    ...
    'settings.autoStartBreaks.desc': 'Inicie as pausas automaticamente após o foco',
    ...
    'settings.scheduleDeleted': 'Cronograma excluído',
    ...
    'profile.personalInfo.desc': 'Gerencie suas informações pessoais e de contato',
    'profile.name': 'Nome',
    ...
    'profile.bio': 'Bio',
    'profile.bio.placeholder': 'Conte um pouco sobre você',
    ...
    'event.createTitle': 'Criar Evento',
    'event.editTitle': 'Editar Evento',
    'event.title': 'Título',
    'event.startTime': 'Data/Hora de Início',
    'event.endTime': 'Data/Hora de Fim',
    ...
    'event.save': 'Salvar',
    'event.create': 'Criar',
    'event.types.class': 'Aula',
    'event.types.study': 'Estudo',
    'event.types.exam': 'Prova',
    'event.types.personal': 'Pessoal',
    'event.types.other': 'Outro',
    'event.colors.blue': 'Azul',
    'event.colors.green': 'Verde',
    'event.colors.red': 'Vermelho',
    'event.colors.purple': 'Roxo',
    'event.colors.orange': 'Laranja',
    'event.colors.pink': 'Rosa',
    'event.colors.yellow': 'Amarelo',
    'event.colors.gray': 'Cinza',
    'event.weekdays.sun': 'Dom',
    'event.weekdays.mon': 'Seg',
    'event.weekdays.tue': 'Ter',
    'event.weekdays.wed': 'Qua',
  ...
  en: {
    ...
    'revision.noRevisionsToday': 'No revisions for today! 🎉',
    ...
    'revision.titleLabel': 'Revision Title:',
    'revision.titlePlaceholder': 'e.g., Calculus I Concepts',
    'revision.contentLabel': 'Content to Review:',
    'revision.contentPlaceholder': 'Describe what needs to be reviewed in detail...',
    'revision.subjectLabel': 'Subject/Course (Optional):',
    'revision.subjectPlaceholder': 'e.g., Mathematics, Biology, History',
    'revision.timeLabel': 'Estimated Time (minutes):',
    'revision.timePlaceholder': '30',
    'revision.nonStudyDaysLabel': 'Non-study days (optional):',
    'revision.nonStudyDaysDescription': 'Reviews scheduled for these days will be automatically postponed to the next study day.',
    'revision.createTitle': 'Create New Revision',
    'revision.createDescription': 'Set up a new revision with spaced repetition system',
    'revision.create': 'Create Revision',
    ...
    'flashcards.deckNamePlaceholder': 'Enter deck name',
    'flashcards.deckDescriptionPlaceholder': 'Enter optional description',
    'flashcards.createNewDeck': 'Create New Deck',
    'flashcards.deckDetailsDescription': 'Set up your new flashcard deck details',
    ...
    'event.title': 'Title',
    'event.startTime': 'Start Date/Time',
    'event.endTime': 'End Date/Time',
    ...
    'event.noRepeat': 'Do not repeat',
    'event.daily': 'Daily',
    'event.weekly': 'Weekly',
    'event.monthly': 'Monthly',
    'event.yearly': 'Yearly',
    'event.weekdays': 'Weekdays',
    'event.addToRevision': 'Add to Spaced Revision',
    'event.addToRevisionDesc': 'Will automatically create a revision for this event on the scheduled date',
    'event.deleteSeries': 'Delete Series',
    'event.delete': 'Delete',
    'event.cancel': 'Cancel',
    'event.save': 'Save',
    'event.create': 'Create',
    'event.types.class': 'Class',
    'event.types.study': 'Study',
    'event.types.exam': 'Exam',
    'event.types.personal': 'Personal',
    'event.types.other': 'Other',
    'event.colors.blue': 'Blue',
    'event.colors.green': 'Green',
    'event.colors.red': 'Red',
    'event.colors.purple': 'Purple',
    'event.colors.orange': 'Orange',
    'event.colors.pink': 'Pink',
    'event.colors.yellow': 'Yellow',
    'event.colors.gray': 'Gray',
    'event.weekdays.sun': 'Sun',
    'event.weekdays.mon': 'Mon',
    'event.weekdays.tue': 'Tue',
    'event.weekdays.wed': 'Wed',
  ...
  es: {
    ...
    'schedule.eventLocation': 'Ubicación del Evento',
    ...
    'schedule.confirmDelete': '¿Estás seguro de que quieres eliminar este evento?',
    ...
    'revision.noRevisionsToday': '¡No hay revisiones para hoy! 🎉',
    'revision.noUpcomingRevisions': 'No hay revisiones próximas',
    ...
    'revision.title.placeholder': 'Título de la revisión',
    'revision.content.placeholder': 'Contenido de la revisión',
    'revision.tags.placeholder': 'Etiquetas (separadas por coma)',
    'revision.difficulty': 'Dificultad',
    'revision.easy': 'Fácil',
    'revision.medium': 'Medio',
    'revision.hard': 'Difícil',
    'revision.created': 'Revisión creada exitosamente',
    'revision.updated': 'Revisión actualizada exitosamente',
    'revision.deleted': 'Revisión eliminada exitosamente',
    'revision.confirmDelete': '¿Estás seguro de que quieres eliminar esta revisión?',
    'revision.editRevision': 'Editar Revisión',
    'revision.saveRevision': 'Guardar Revisión',
    'revision.cancelRevision': 'Cancelar',
    'revision.titleLabel': 'Título de la Revisión:',
    'revision.titlePlaceholder': 'ej: Conceptos de Cálculo I',
    'revision.contentLabel': 'Contenido para Revisar:',
    'revision.contentPlaceholder': 'Describe lo que necesita ser revisado en detalle...',
    'revision.subjectLabel': 'Materia/Disciplina (Opcional):',
    'revision.subjectPlaceholder': 'ej: Matemáticas, Biología, Historia',
    'revision.timeLabel': 'Tiempo Estimado (minutos):',
    'revision.timePlaceholder': '30',
    'revision.nonStudyDaysLabel': 'Días que no estudias (opcional):',
    'revision.nonStudyDaysDescription': 'Las revisiones programadas para estos días se pospondrán automáticamente al siguiente día de estudio.',
    'revision.createTitle': 'Crear Nueva Revisión',
    'revision.createDescription': 'Configura una nueva revisión con sistema de repetición espaciada',
    'revision.create': 'Crear Revisión',
    'revision.cancel': 'Cancelar',
    ...
    'flashcards.deckNamePlaceholder': 'Ingresa el nombre del mazo',
    'flashcards.deckDescriptionPlaceholder': 'Ingresa una descripción opcional',
    'flashcards.createNewDeck': 'Crear Nuevo Mazo',
    'flashcards.deckDetailsDescription': 'Configura los detalles de tu nuevo mazo de tarjetas',
    ...
    'settings.notifications.desc': 'Configura tus preferencias de notificación',
    ...
    'settings.autoStartBreaks.desc': 'Inicia pausas automáticamente después del enfoque',
    ...
    'profile.personalInfo.desc': 'Gestiona tu información personal y de contacto',
    'profile.name': 'Nombre',
    ...
    'profile.phone.placeholder': 'Ingresa tu teléfono',
    'profile.bio': 'Bio',
    ...
    'profile.currentPassword.placeholder': 'Ingresa tu contraseña actual',
    'profile.newPassword.placeholder': 'Ingresa tu nueva contraseña',
    'profile.confirmPassword.placeholder': 'Confirma tu nueva contraseña',
    ...
    // Event Modal translations
    'event.createTitle': 'Crear Evento',
    'event.editTitle': 'Editar Evento',
    'event.title': 'Título',
    'event.startTime': 'Fecha/Hora de Inicio',
    'event.endTime': 'Fecha/Hora de Fin',
    'event.description': 'Descripción',
    'event.type': 'Tipo',
    'event.location': 'Ubicación',
    'event.professor': 'Profesor',
    'event.color': 'Color del Evento',
    'event.recurrence': 'Recurrencia',
    'event.noRepeat': 'No repetir',
    'event.daily': 'Diariamente',
    'event.weekly': 'Semanalmente',
    'event.monthly': 'Mensualmente',
    'event.yearly': 'Anualmente',
    'event.weekdays': 'Días de la Semana',
    'event.addToRevision': 'Agregar a Revisión Espaciada',
    'event.addToRevisionDesc': 'Creará automáticamente una revisión para este evento en la fecha programada',
    'event.deleteSeries': 'Eliminar Serie',
    'event.delete': 'Eliminar',
    'event.cancel': 'Cancelar',
    'event.save': 'Guardar',
    'event.create': 'Crear',
    'event.types.class': 'Clase',
    'event.types.study': 'Estudio',
    'event.types.exam': 'Examen',
    'event.types.personal': 'Personal',
    'event.types.other': 'Otro',
    'event.colors.blue': 'Azul',
    'event.colors.green': 'Verde',
    'event.colors.red': 'Rojo',
    'event.colors.purple': 'Morado',
    'event.colors.orange': 'Naranja',
    'event.colors.pink': 'Rosa',
    'event.colors.yellow': 'Amarillo',
    'event.colors.gray': 'Gris',
    'event.weekdays.sun': 'Dom',
    'event.weekdays.mon': 'Lun',
    'event.weekdays.tue': 'Mar',
    'event.weekdays.wed': 'Mié',
